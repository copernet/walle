...
class DisconnectBanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(
            -8, "Only one of address and nodeid should be provided.",
        ...
        assert_raises_rpc_error(-8, "Invalid address or node ID",
                                self.nodes[0].disconnectnode, address="221B Baker Street")
        assert_raises_rpc_error(-29, "Node not found in connected nodes",
                                self.nodes[0].disconnectnode, address="128.0.0.1:8333")

        self.log.info(
            "disconnectnode: successfully disconnect node by address")
        # sequence: inbound - outbound - persistent
