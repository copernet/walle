...
BAD_OPCODE_ERROR = b'module: tx_validation, errcode: 16: mandatory-script-verify-flag-failed (OpCode missing or not understood)'
RPC_BAD_OPCODE_ERROR = BAD_OPCODE_ERROR.decode("utf-8")
